...
function Card3({ name }) {
  return (
    <div
      ...
      className="sm:h-[300px] w-full justify-end lg:p-5 p-2 h-[230px] text-shadow-lg Card3 border-4 border-[var(--white)] lg:rounded-4xl rounded-2xl shadow-lg flex flex-col  lg:h-[365px]"
    >
