...
function ContactUS() {
  return (
    <section
      id="contactUs"
      className="w-full relative bg-[var(--grey)] flex justify-center items-center"
    >
      <div className="flex flex-col px-2 mb-20 gap-5 items-center">
        ...
        >
          <Phone
            ...
            size={40}
          />
          <h3 style={{ fontFamily: "DynaPuff" }} className="text-xl font-bold">
            Contact Us
          </h3>
          <p>
            Have a question, need support, or want to place an order? We’d love
            to hear from you Reach out to us anytime and we’ll get back to you
            as soon as possible. Whether it’s enquires, custom requests, or
            general feedback, our team is always ready to help
          </p>
        </motion.div>
        <div className="flex gap-3 lg:max-w-[800px] w-full flex-wrap items-center">
          ...
          >
            ...
            <div className="flex items-center flex-col gap-2">
              <span className="py-2 px-4 min-w-[180px] text-center bg-[var(--grey)] rounded-4xl">
                {" "}
                0907 909 8366
              </span>

              <a
                className="py-2 text-center min-w-[180px] px-4 text-[var(--wine-red)] bg-[var(--grey)] rounded-4xl"
                target="_blank"
