...
function Card({ name }) {
  return (
    <div
      ...
      className="lg:max-w-[275px] max-w-[150px] sm:max-w-[375px] sm:h-[300px] w-full justify-end lg:p-5 p-2 h-[265px] text-shadow-lg Card border-4 border-[var(--white)] lg:rounded-4xl rounded-2xl shadow-lg flex flex-col  lg:h-[365px]"
    >
