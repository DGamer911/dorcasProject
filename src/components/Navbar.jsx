...
function NavBar() {
  const iconSize = 18;
  return (
    <nav className="shadow-lg mt-10 rounded-xl flex bg-[var(--white)] p-3 items-center justify-around  lg:w-[700px] sm:w-[500px] w-[300px]">
      ...
      <div className="navLinks  hover:text-[var(--accent)] hover:duration-200 hover:ease-in ">
        <Link className="flex text-sm  items-center flex-col  gap-1" to="/store"><ShoppingBagIcon size={iconSize}/><span>Shop</span></Link>
      </div>
      <div className="navLinks  hover:text-[var(--accent)] hover:duration-200 hover:ease-in ">
